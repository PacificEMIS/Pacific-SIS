...
namespace opensis.data.Migrations.MySqlMigrations
{
    ...
    [Migration("20210423092005_AddTableCourseCommentCategoryAndStudentFinalGradeComments")]
    partial class AddTableCourseCommentCategoryAndStudentFinalGradeComments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("opensis.data.Models.ReportCardComments", b =>
                {
                    ...
                    b.HasIndex("TenantId", "SchoolId", "Id")
                        .IsUnique()
                        .HasName("IX_report_card_comments");
            ...
            modelBuilder.Entity("opensis.data.Models.StudentFinalGrade", b =>
                {
                    ...
                    b.HasKey("TenantId", "SchoolId", "StudentId", "CalendarId", "YrMarkingPeriodId", "SmstrMarkingPeriodId", "QtrMarkingPeriodId");
            ...
            modelBuilder.Entity("opensis.data.Models.StudentFinalGradeComments", b =>
                {
                    ...
                    b.HasKey("TenantId", "SchoolId", "StudentId", "CalendarId", "YrMarkingPeriodId", "SmstrMarkingPeriodId", "QtrMarkingPeriodId", "Id")
                        .HasName("PK_student_final_grade_comments_1");
            ...
            modelBuilder.Entity("opensis.data.Models.CourseCommentCategory", b =>
                {
                    b.HasOne("opensis.data.Models.SchoolMaster", "SchoolMaster")
                        .WithMany("CourseCommentCategory")
                        .HasForeignKey("TenantId", "SchoolId")
                        .HasConstraintName("FK_comment_category_school_master")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("opensis.data.Models.ReportCardComments", b =>
                {
                    b.HasOne("opensis.data.Models.CourseCommentCategory", "CourseCommentCategory")
                        .WithOne("ReportCardComments")
                        .HasForeignKey("opensis.data.Models.ReportCardComments", "TenantId", "SchoolId", "CourseCommentId")
                        .HasConstraintName("FK_report_card_comments_course_comment_category")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("opensis.data.Models.StudentFinalGradeComments", b =>
                {
                    b.HasOne("opensis.data.Models.ReportCardComments", "ReportCardComments")
                        ...
                        .HasForeignKey("TenantId", "SchoolId", "Id")
                        .HasConstraintName("FK_student_final_grade_comments_report_card_comments")
                        .HasPrincipalKey("TenantId", "SchoolId", "Id")
                        .IsRequired();

                    b.HasOne("opensis.data.Models.StudentFinalGrade", "StudentFinalGrade")
                        .WithMany("StudentFinalGradeComments")
                        .HasForeignKey("TenantId", "SchoolId", "StudentId", "CalendarId", "YrMarkingPeriodId", "SmstrMarkingPeriodId", "QtrMarkingPeriodId")
                        .HasConstraintName("FK_student_final_grade_comments_student_final_grade")
                        .IsRequired();
                });
