...
namespace opensis.data.Migrations.MySqlMigrations
{
    ...
    [Migration("20210105185806_AddTableSubjectProgramCourseAndCourseStandard")]
    partial class AddTableSubjectProgramCourseAndCourseStandard
    {
            ...
            modelBuilder.Entity("opensis.data.Models.Course", b =>
                {
                    ...
                    b.Property<string>("GradeUsStandard")
                        .HasColumnName("grade_us_standard")
                        .HasColumnType("varchar(50) CHARACTER SET utf8mb4")
                        .HasMaxLength(50)
                        .IsUnicode(false);
            ...
            modelBuilder.Entity("opensis.data.Models.StudentEnrollmentCode", b =>
                {
                    ...
                    b.Property<int?>("SchoolMasterSchoolId")
                        .HasColumnType("int");

                    b.Property<Guid?>("SchoolMasterTenantId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("SchoolMasterTenantId", "SchoolMasterSchoolId");
            ...
            modelBuilder.Entity("opensis.data.Models.StudentEnrollmentCode", b =>
                {
                    b.HasOne("opensis.data.Models.SchoolMaster", "SchoolMaster")
                        ...
                        .HasForeignKey("SchoolMasterTenantId", "SchoolMasterSchoolId");
                });
