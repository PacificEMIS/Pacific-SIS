        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			string studentMedicalListView =
				   @"
					...
					AS
					SELECT student_master.school_id, student_master.student_id, student_master.tenant_id, student_master.student_guid, student_medical_alert.alert_type, student_medical_alert.alert_description, student_medical_note.note_date, 
					...
					FROM student_master LEFT JOIN
						...
						student_master.student_id = student_medical_note.student_id LEFT JOIN
						...
						student_master.student_id = student_medical_alert.student_id LEFT JOIN
						...
						student_master.student_id = student_medical_nurse_visit.student_id LEFT JOIN
