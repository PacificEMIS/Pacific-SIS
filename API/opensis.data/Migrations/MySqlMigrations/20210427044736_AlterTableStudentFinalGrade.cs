...
namespace opensis.data.Migrations.MySqlMigrations
{
    public partial class AlterTableStudentFinalGrade : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropIndex(
                name: "IX_student_final_grade_tenant_id_school_id_course_id_course_sec~",
                table: "student_final_grade");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    applicable_all_courses = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    comments = table.Column<string>(type: "varchar(500) CHARACTER SET utf8mb4", unicode: false, maxLength: 500, nullable: true),
                    course_id = table.Column<int>(type: "int", nullable: false),
                    course_section_id = table.Column<int>(type: "int", nullable: false),
                    created_by = table.Column<string>(type: "varchar(150) CHARACTER SET utf8mb4", unicode: false, maxLength: 150, nullable: true),
                    created_on = table.Column<DateTime>(type: "datetime", nullable: true),
                    id = table.Column<int>(type: "int", nullable: false),
                    sort_order = table.Column<int>(type: "int", nullable: true),
                    updated_by = table.Column<string>(type: "varchar(150) CHARACTER SET utf8mb4", unicode: false, maxLength: 150, nullable: true),
                    updated_on = table.Column<DateTime>(type: "datetime", nullable: true)
                },
                constraints: table =>
                {
