...
namespace opensis.data.Migrations.MySqlMigrations
{
    ...
    [Migration("20210709095258_AlterColumnWeightedAndUnweightedGPValueInGradeTable")]
    partial class AlterColumnWeightedAndUnweightedGPValueInGradeTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("opensis.data.Models.GradebookConfigurationFinalGrading", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnName("id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("gradebook_configuration_final_grading");
                });
            ...
            modelBuilder.Entity("opensis.data.Models.GradebookConfigurationGradescale", b =>
                {
                    ...
                    b.ToTable("gradebook_configuration_gradescale");
                });
            ...
            modelBuilder.Entity("opensis.data.Models.GradebookConfigurationFinalGrading", b =>
                {
                    b.HasOne("opensis.data.Models.Quarters", "Quarters")
                        .WithMany("GradebookConfigurationFinalGrading")
                        .HasForeignKey("TenantId", "SchoolId", "QtrMarkingPeriodId")
                        .HasConstraintName("FK_gradebook_configuration_final_grading_quarters");

                    b.HasOne("opensis.data.Models.Semesters", "Semesters")
                        .WithMany("GradebookConfigurationFinalGrading")
                        .HasForeignKey("TenantId", "SchoolId", "SmstrMarkingPeriodId")
                        .HasConstraintName("FK_gradebook_configuration_final_grading_semesters");

                    b.HasOne("opensis.data.Models.SchoolYears", "SchoolYears")
                        .WithMany("GradebookConfigurationFinalGrading")
                        .HasForeignKey("TenantId", "SchoolId", "YrMarkingPeriodId")
                        .HasConstraintName("FK_gradebook_configuration_final_grading_school_years");
                    ...
                    b.HasOne("opensis.data.Models.GradebookConfiguration", "GradebookConfiguration")
                        ...
                        .HasConstraintName("FK_gradebook_configuration_final_grading_gradebook_configuration")
                        .IsRequired();
                });
