...
namespace opensis.data.Migrations.MySqlMigrations
{
    ...
    [Migration("20201103075304_AddCountryInStudentMasterTable")]
    partial class AddCountryInStudentMasterTable
    {
            ...
            modelBuilder.Entity("opensis.data.Models.StudentMaster", b =>
                {
                    ...
                    b.Property<string>("DisplayAge")
                        .HasColumnName("display_age")
                        .HasColumnType("varchar(100) CHARACTER SET utf8mb4")
                        .HasMaxLength(100)
                        .IsUnicode(false);
