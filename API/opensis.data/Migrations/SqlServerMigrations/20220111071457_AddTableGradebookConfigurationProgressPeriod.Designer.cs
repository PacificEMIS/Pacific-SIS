...
namespace opensis.data.Migrations.SqlServerMigrations
{
    ...
    [Migration("20220111071457_AddTableGradebookConfigurationProgressPeriod")]
    partial class AddTableGradebookConfigurationProgressPeriod
    {
            ...
            modelBuilder.Entity("opensis.data.Models.CourseSection", b =>
                {
                    ...
                    b.HasIndex("TenantId", "SchoolId", "PrgrsprdMarkingPeriodId", "AcademicYear", "QtrMarkingPeriodId");
            ...
            modelBuilder.Entity("opensis.data.Models.CourseSection", b =>
                {
                    ...
                    b.HasOne("opensis.data.Models.ProgressPeriods", "ProgressPeriods")
                        ...
                        .HasForeignKey("TenantId", "SchoolId", "PrgrsprdMarkingPeriodId", "AcademicYear", "QtrMarkingPeriodId")
            ...
            modelBuilder.Entity("opensis.data.Models.GradebookConfigurationProgressPeriod", b =>
                {
                    b.HasOne("opensis.data.Models.ProgressPeriods", "ProgressPeriod")
                        ...
                        .HasForeignKey("TenantId", "SchoolId", "PrgrsprdMarkingPeriodId", "AcademicYear", "QtrMarkingPeriodId")
                        .HasConstraintName("FK_gradebook_conf_progressPeriod");
            ...
            modelBuilder.Entity("opensis.data.Models.GradebookConfigurationQuarter", b =>
                {
                    ...
                    b.HasOne("opensis.data.Models.ProgressPeriods", "ProgressPeriod")
                        .WithMany("GradebookConfigurationQuarters")
                        .HasForeignKey("TenantId", "SchoolId", "PrgrsprdMarkingPeriodId", "AcademicYear", "QtrMarkingPeriodId")
                        .HasConstraintName("FK_gradebook_configuration_quarter_progress_periods");
            ...
            modelBuilder.Entity("opensis.data.Models.StaffCoursesectionSchedule", b =>
                {
                    ...
                    b.HasOne("opensis.data.Models.ProgressPeriods", "ProgressPeriod")
                        ...
                        .HasForeignKey("TenantId", "SchoolId", "PrgrsprdMarkingPeriodId", "AcademicYear", "QtrMarkingPeriodId")
                        .HasConstraintName("FK_staff_cs_sch_periods");
            ...
            modelBuilder.Entity("opensis.data.Models.StudentEffortGradeMaster", b =>
                {
                    ...
                    b.HasOne("opensis.data.Models.ProgressPeriods", "ProgressPeriod")
                        ...
                        .HasForeignKey("TenantId", "SchoolId", "PrgrsprdMarkingPeriodId", "AcademicYear", "QtrMarkingPeriodId")
                        .HasConstraintName("FK_student_effort_grade_periods");
            ...
            modelBuilder.Entity("opensis.data.Models.StudentFinalGrade", b =>
                {
                    ...
                    b.HasOne("opensis.data.Models.ProgressPeriods", "ProgressPeriod")
                        ...
                        .HasForeignKey("TenantId", "SchoolId", "PrgrsprdMarkingPeriodId", "AcademicYear", "QtrMarkingPeriodId")
                        .HasConstraintName("FK_student_final_grade_periods");
            ...
            modelBuilder.Entity("opensis.data.Models.ProgressPeriods", b =>
                {
                    ...
                    b.Navigation("GradebookConfigurationQuarters");
