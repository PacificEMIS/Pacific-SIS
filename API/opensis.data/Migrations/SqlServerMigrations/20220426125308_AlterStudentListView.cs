...
{
    public partial class AlterStudentListView : Migration
    {
            ...
            string studentListView =
                  @"
                    ...
                    LEFT OUTER JOIN dbo.sections ON (((dbo.student_master.tenant_id = dbo.sections.tenant_id)
                        ...
                        (SELECT dbo.student_enrollment.student_id,dbo.student_enrollment.school_id, MAX(dbo.student_enrollment.enrollment_date) AS enrollment_date
                                 FROM dbo.student_enrollment
                                 GROUP BY dbo.student_enrollment.student_id,dbo.student_enrollment.school_id) max_enrollment_date
