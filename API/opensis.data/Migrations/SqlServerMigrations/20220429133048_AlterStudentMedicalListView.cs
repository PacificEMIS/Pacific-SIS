...
{
    public partial class AlterStudentMedicalListView : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            string studentMedicalListView =
                  @"
                    ...
                    AS
                    SELECT dbo.student_master.school_id, dbo.student_master.student_id, dbo.student_master.tenant_id, dbo.student_master.student_guid, dbo.student_medical_alert.alert_type, dbo.student_medical_alert.alert_description, dbo.student_medical_note.note_date, 
                    ...
                    FROM dbo.student_master LEFT JOIN
                        ...
                        dbo.student_master.student_id = dbo.student_medical_note.student_id LEFT JOIN
                        ...
                        dbo.student_master.student_id = dbo.student_medical_alert.student_id LEFT JOIN
                        ...
                        dbo.student_master.student_id = dbo.student_medical_nurse_visit.student_id LEFT JOIN
