...
namespace opensis.data.Migrations.SqlServerMigrations
{
    ...
    [Migration("20210223150916_AddTableRoleAndAccess")]
    partial class AddTableRoleAndAccess
    {
            ...
            modelBuilder.Entity("opensis.data.Models.RolePermission", b =>
                {
                    ...
                    b.HasIndex("TenantId", "SchoolId", "RoleId");

                    b.ToTable("role_permission");
                });

            modelBuilder.Entity("opensis.data.Models.Roles", b =>
                {
                    b.Property<Guid>("TenantId")
                        .HasColumnName("tenant_id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("TenantId", "SchoolId", "RoleId")
                        .HasName("PK_roles_1");
            ...
            modelBuilder.Entity("opensis.data.Models.RolePermission", b =>
                {
                    ...
                    b.HasOne("opensis.data.Models.Roles", "Roles")
                        .WithMany("RolePermission")
                        .HasForeignKey("TenantId", "SchoolId", "RoleId")
