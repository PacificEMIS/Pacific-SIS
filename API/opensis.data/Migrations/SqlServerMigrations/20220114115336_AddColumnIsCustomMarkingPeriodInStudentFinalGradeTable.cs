    ...
    public partial class AddColumnIsCustomMarkingPeriodInStudentFinalGradeTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_student_final_grade_tenant_id_school_id_prgrsprd_marking_period_id",
                table: "student_final_grade",
                columns: new[] { "tenant_id", "school_id", "prgrsprd_marking_period_id" });

            migrationBuilder.CreateIndex(
                name: "IX_student_effort_grade_master_tenant_id_school_id_prgrsprd_marking_period_id",
                table: "student_effort_grade_master",
                columns: new[] { "tenant_id", "school_id", "prgrsprd_marking_period_id" });

            migrationBuilder.CreateIndex(
                name: "IX_staff_coursesection_schedule_tenant_id_school_id_prgrsprd_marking_period_id",
                table: "staff_coursesection_schedule",
                columns: new[] { "tenant_id", "school_id", "prgrsprd_marking_period_id" });

            migrationBuilder.CreateIndex(
                name: "IX_gradebook_configuration_progressPeriod_tenant_id_school_id_prgrsprd_marking_period_id",
                table: "gradebook_configuration_progressPeriod",
                columns: new[] { "tenant_id", "school_id", "prgrsprd_marking_period_id" });
