    ...
    public partial class AlterAllCourseSectionScheduleTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_course_variable_schedule_tenant_id_school_id_block_id_period_id",
                table: "course_variable_schedule",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_course_calendar_schedule_tenant_id_school_id_block_id_period_id",
                table: "course_calendar_schedule",
                columns: new[] { "tenant_id", "school_id", "block_id", "period_id" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    block = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: true),
                    end_time = table.Column<TimeSpan>(type: "time", nullable: true),
                    ignore_scheduling = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: true),
                    last_updated = table.Column<DateTime>(type: "datetime", nullable: true),
                    length = table.Column<decimal>(type: "decimal(10, 0)", nullable: true),
