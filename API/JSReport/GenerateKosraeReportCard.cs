...
namespace JSReport
{
   public class GenerateKosraeReportCard
    {
        ...
        public async Task<string> Generate(object data)
        {
            ...
            try
            {
                ...
                if (isWindows)
                {
                  ...
                  .Create();
                    ...
                    var studentReport = rs.RenderByNameAsync("KosraeReportTemplate", data).Result;

                    using (var fs = File.Create("ReportCard\\StudentKosraeReportCard.pdf"))
                    {
            ...
            {
                logger.Error("Method GenerateKosraeReportCard end with error :" + ex.Message);
                msg = ex.Message;
            }
            return msg;
        }
