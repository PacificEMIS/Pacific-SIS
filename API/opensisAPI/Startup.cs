...
using opensis.core.ParentPortal.Services;
...
namespace opensisAPI
{
    public class Startup
    {
        ...
        {
            // Honor X-Forwarded-For from the reverse proxy (Apache on loopback in production)
            // so HttpContext.Connection.RemoteIpAddress reflects the real client IP.
