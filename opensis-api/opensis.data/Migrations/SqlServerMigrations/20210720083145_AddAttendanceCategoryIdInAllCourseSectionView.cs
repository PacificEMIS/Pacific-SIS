...
{
    public partial class AddAttendanceCategoryIdInAllCourseSectionView : Migration
    {
            ...
            string script =
                   @"
                    ...
                    SELECT dbo.course.tenant_id, dbo.course.school_id, dbo.course.course_id, dbo.course.course_title, dbo.course.course_subject, dbo.course.course_program, dbo.course_section.academic_year, dbo.course_section.course_section_id, 
                         ...
                         dbo.course_variable_schedule.take_attendance AS take_attendance_variable, dbo.course_calendar_schedule.take_attendance AS take_attendance_calendar, dbo.course_block_schedule.take_attendance AS take_attendeace_block, dbo.course_block_schedule.block_id, dbo.course_section.attendance_category_id
