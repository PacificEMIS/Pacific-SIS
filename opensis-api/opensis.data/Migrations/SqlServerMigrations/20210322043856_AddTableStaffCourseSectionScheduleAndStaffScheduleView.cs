...
namespace opensis.data.Migrations.SqlServerMigrations
{
    public partial class AddTableStaffCourseSectionScheduleAndStaffScheduleView : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_staff_coursesection_schedule_tenant_id_school_id_qtr_marking_period_id",
                table: "staff_coursesection_schedule",
                columns: new[] { "tenant_id", "school_id", "qtr_marking_period_id" });

            migrationBuilder.CreateIndex(
                name: "IX_staff_coursesection_schedule_tenant_id_school_id_smstr_marking_period_id",
                table: "staff_coursesection_schedule",
                columns: new[] { "tenant_id", "school_id", "smstr_marking_period_id" });

            migrationBuilder.CreateIndex(
                name: "IX_staff_coursesection_schedule_tenant_id_school_id_yr_marking_period_id",
                table: "staff_coursesection_schedule",
                columns: new[] { "tenant_id", "school_id", "yr_marking_period_id" });

            migrationBuilder.CreateIndex(
                name: "IX_staff_coursesection_schedule_tenant_id_school_id_course_id_course_section_id",
                table: "staff_coursesection_schedule",
