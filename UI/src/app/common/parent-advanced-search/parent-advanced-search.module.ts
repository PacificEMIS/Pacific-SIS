...
import { ParentRoutingModule } from 'src/app/pages/parent/parent-routing-module';
...
@NgModule({
  ...
  exports: [ParentAdvancedSearchComponent]
})
export class ParentAdvancedSearchModule { }
