...
import { StudentMasterSearchModel } from '../../../../../models/student.model';
...
import { GetStudentAbsenceReport } from 'src/app/models/absence-summary.model';
...
export class SearchStudentComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  getAllStudent: GetStudentAbsenceReport = new GetStudentAbsenceReport();
  ...
  search() {
    ...
    this.getAllStudent.markingPeriodStartDate=this.parentData.markingPeriodStartDate;
    this.getAllStudent.markingPeriodEndDate=this.parentData.markingPeriodEndDate;
    this.getAllStudent.periodId=this.parentData.periodId;
    this.commonService.setSearchResult(this.getAllStudent.filterParams);
    this.reportService.getAllStudentAbsenceList(this.getAllStudent).subscribe(data => {
      if (data._failure) {
        this.commonService.checkTokenValidOrNot(data._message);
