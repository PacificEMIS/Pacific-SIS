    ...
    if (this.form.valid) { 
      if(this.form.controls.id.value==0){
        ...
        this.commonService.addDropdownValue(this.lovAddView).subscribe(
          (res:LovAddView)=>{
            if(typeof(res)=='undefined'){
              this.snackbar.open('Male Toilet Type insertion failed. ' +this.defaultValuesService.getHttpError(), '', {
                duration: 10000
              });
            }
            else{
        ...
        this.commonService.updateDropdownValue(this.lovAddView).subscribe(
          (res:LovAddView)=>{
            if(typeof(res)=='undefined'){
              this.snackbar.open('Male Toilet Type Update failed. ' + this.defaultValuesService.getHttpError(), '', {
                duration: 10000
              });
            }
            else{
